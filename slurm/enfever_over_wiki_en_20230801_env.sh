...
export DEV=/mnt/data/factcheck/fever/data-en-lrev/fever-data/${SPLIT}.jsonl 
export RETRIEVAL=${ROOT}/retrieval/enfever_over_wiki_en
export PREDICTIONS=${RETRIEVAL}/predicted.${SPLIT}.tsv
export OUTPUT=${ROOT}/predictions/enfever_over_wiki_en/${SPLIT}_anserini_k500_${k1}_${b}/predictions.jsonl
