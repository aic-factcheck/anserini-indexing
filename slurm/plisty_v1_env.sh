...
export ROOT=/mnt/data/newton/parlamentni_listy/factcheck/v1/anserini
export LANG=cs

# compute index
export inputDataFolder=/mnt/data/newton/parlamentni_listy/factcheck/v1/interim/paragraphs
