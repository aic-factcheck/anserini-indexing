...
export LANG=en
export DATE=20240201
export ROOT="/mnt/data/factcheck/wiki/$LANG/$DATE/anserini"

# compute index
export inputDataFolder="/mnt/data/factcheck/wiki/$LANG/$DATE/paragraphs/json"
...
QACG_MODELS=/stanza/mt5-large_all-cp126k/mt5-large_all-cp156k
export DEV="/mnt/data/factcheck/wiki/en/20230801/qacg/splits/${QACG_MODELS}/${SPLIT}.jsonl"
